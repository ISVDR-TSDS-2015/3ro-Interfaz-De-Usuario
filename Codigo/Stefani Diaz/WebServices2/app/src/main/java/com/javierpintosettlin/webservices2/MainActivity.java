...
public class MainActivity extends ActionBarActivity {
    ...
    private class TareaAccesoSOAP extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... urls) {
            ...
            try {
                ...
                androidHttpTransport.call(SOAP_ACTION, Sobre);

                SoapObject resultado_object =(SoapObject)Sobre.getResponse();
    ...
    public List<Kiosco> RecibirDeSOAP(SoapObject soap)
    {
        ...
        for (int i=0; i < soap.getPropertyCount(); i++)
            // i++ significa q avanza de a uno... es como 1+1
        {
            ...
            //directamente la ciudad es un objetoSoap dentro del objeto de kiosco
